...
<script>const useDarkMode = window.matchMedia("(prefers-color-scheme: dark)").matches,
    ...
    tinymce.init({
        ...
        branding: !1,
        promotion: !1,
        plugins: "preview importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen fontsize image link media  table charmap nonbreaking anchor insertdatetime advlist lists wordcount help charmap quickbars emoticons accordion",
        editimage_cors_hosts: ["picsum.photos"],
        menubar: "file edit view insert format tools table help",
        toolbar: "insertfile fontsize a11ycheck undo redo | blocks  bold italic underline strikethrough blockquote emoticons |  forecolor backcolor  | alignleft aligncenter alignright alignjustify bullist numlist table | link image media fullscreen preview | code",
        toolbar_sticky: !1,
        language: "ru",
        image_advtab: !0,
        height: 450,
