    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title" key="t-apps">Murojaatlar</li>
                <li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="bx bx-paperclip"></i>
                        <span key="">Murojaatlar</span>
                    </a>

                    <ul class="sub-menu" aria-expanded="false">
                        @php
                            $new_y = \Illuminate\Support\Facades\DB::select("Select * from yuridik_murojaats where status = 'new' ");
                            $new_j = \Illuminate\Support\Facades\DB::select("Select * from jismoniy_murojaats where status = 'new' ");
                            $new = count($new_j) + count($new_y);
                        @endphp
                        <li><a href="{{ route('new_murojaats') }}">Yangi kelgan <span
                                    style="color: white">({{$new}})</span></a></li>
                        <li><a href="{{ route('old_murojaats') }}">Ko'rib chiqilgan</a></li>
                    </ul>
                </li>
