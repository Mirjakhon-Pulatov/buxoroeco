                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="new-murojaat" class=" table table-bordered dt-responsive  nowrap w-100">
                            ...
                            @php
                                $yms = \Illuminate\Support\Facades\DB::select("Select * from `yuridik_murojaats` where `status` = 'done' order by `id` desc");
                            @endphp
                            <tbody>
                            @foreach($yms as $ym)
                                <tr>
                                    ...
                                    <td style="text-align:  center" class="d-flex justify-content-evenly">
                                        <a title="Ko'rish"
                                           href="{{ route('view_old',['type'=>'yuridik', 'code'=>$ym->code]) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="new-murojaat1" class=" table table-bordered dt-responsive  nowrap w-100">
                            ...
                            @php
                                $jms = \Illuminate\Support\Facades\DB::select("Select * from `jismoniy_murojaats` where `status` = 'done' order by `id` desc");
                            @endphp
                            ...
                            @foreach($jms as $jm)
                                <tr>
                                    ...
                                    <td style="text-align:  center" class="d-flex justify-content-evenly">
                                        <a title="Ko'rish"
                                           href="{{ route('view_old',['type'=>'jismoniy', 'code'=>$jm->code]) }}"
                                           class="btn btn-outline-primary"><i
                                                class="fas fa-eye"></i></a>
