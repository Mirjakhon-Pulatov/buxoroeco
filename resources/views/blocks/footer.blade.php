<div class="rts-footer-one footer-bg-two">
    <div class="shape-image-f-2">
        <img src="{{ asset('public/styles/assets/images/footer/07.png') }}" alt="shape-footer">
    </div>
    <div class="container">
            ...
            <div class="col-lg-12">
                <div class="single-footer-one-wrapper two">
                    <div class="single-footer-component first">
                        <a href="{{ url('/') }}" class="logo-area-footer">
                            <img src="{{ asset('public/styles/assets/images/logo-color-white.png') }}" alt="logo">
                        </a>
                        <div class="body mt--45">
                            <p class="disc">
                                Materiallardan foydalanganda www.eco.gov.uz saytiga havola <br> ko’rsatish kerak.
                            </p>
                            ...
                            <div class="rts-social-style-one">
                                <ul>
                                    ...
                                    <li>
                                        <a href="https://www.youtube.com/@Buxoro-ecologiya">
                            ...
                            <div class="footer-contact-wrapper-2">
                                ...
                                <div class="contact-single">
                                    ...
                                    <div class="info-content ml-dec-5">
                                        ...
                                        <span>Qo'llab-quvvatlash uchun</span>
                                    </div>
                                </div>
                                ...
                                <div class="contact-single">
                                    ...
                                    <div class="info-content ml-dec-5">
                                        <a href="tel:+998 (97) 307-20-90">
                                            <h6 class="title">+998 (97) 307-20-90</h6>
                                        </a>
                                        <span>Korrupsiyaga qarshi kurash</span>
                                    </div>
                                </div>
                                <!-- single contact area start -->
                                <div class="contact-single">
                                    ...
                                    <div class="info-content">
                                        <a href="mailto:buxoro@uznature.uz">
                                            <h6 class="title">buxoro@uznature.uz</h6>
                                        </a>
                                        <span>So'rov uchun</span>
                                    </div>
                                </div>
                                <!-- single contact area end -->
                                <!-- single contact area start -->
        ...
        <div class="row pb--20 pt--20 border-top-copyright">
            <div class="col-lg-12">
                ...
                <div class="copyright-area-two">
                    <div class="left">
                        <p>
                            © {{ date('Y') }} <a href="https://bizzone.uz" target="_blank">Bizzone.uz</a>. Barcha huquqlar himoyalangan.
                        </p>
                    </div>
                    <!-- <div class="right">
                    <ul>
