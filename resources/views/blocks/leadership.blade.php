...
@section('seo')
<title>Buxoro viloyati Ekologiya, аtrof - muhitni muhofaza qilish va iqlim o‘zgarish boshqarmasi | Rahbariyat</title>
    ...
    <meta property="og:description" content="buxoro, ekologiya, ekologiya boshqarmasi, buxoroeco.uz, tabiat, ekologik nazorat, aloqa, murojaat, rahbariyat, {{ url()->current() }}">
    ...
    <meta name="twitter:description" content="buxoro, ekologiya, ekologiya boshqarmasi, buxoroeco.uz, tabiat, ekologik nazorat, aloqa, murojaat,rahbariyat, {{ url()->current() }}">
...
@section('content')
    ...
    @foreach($leaders as $leader)
        <div class="personal-info-area-start rts-section-gapTop pb--100">
            @php
                $item_id = $leader->code;
                $photo = app('App\Http\Controllers\Featured_imagesController')->getImage('leadership', $item_id);
            @endphp
            <div class="container">
                            ...
                            <div class="inner-content sal-animate">
                                ...
                                <div class="single-info">
                                    ...
                                    <div class="info">
                                        ...
                                        <a href="#" class="mail">{{ $leader->q_days }}</a>
                                    </div>
                                </div>
                                <!-- ingle information end -->
                            </div>
