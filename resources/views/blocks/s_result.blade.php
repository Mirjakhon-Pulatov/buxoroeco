...
@section('content')
    ...
    <div class="rts-blog-list-area rts-section-gap" style="padding-top: 60px;">
        <div class="container">
            <div class="row g-5">
                <!-- rts blo post area -->
                <div class="col-xl-8 col-md-12 col-sm-12 col-12" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; height: 200px;">
                    <div class="left-service-details-wrapper" style="padding-left: 15px;">
                        <div class="content--sd-top  reveal">
                            <p class="disc-1">
                            <h4>Sizning murojaatingiz muvaffaqiyatli yuborildi</h4>
                            <h5>Murojaat raqami: <span style="color: #4AAB3D">{{ $t }}</span></h5>
