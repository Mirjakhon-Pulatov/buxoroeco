            ...
            <div class="col-lg-12">
                <div class="single-footer-one-wrapper two">
                    <div class="single-footer-component first">
                        <a href="{{ url('/ru') }}" class="logo-area-footer">
                            <img src="{{ asset('public/styles/assets/images/logo-color-white.png') }}" alt="logo">
                        </a>
                        <div class="body mt--45">
                            <p class="disc">
                                При использовании материалов обращайтесь на сайт www.eco.gov.uz.
                            </p>
        ...
        <div class="row pb--20 pt--20 border-top-copyright">
            <div class="col-lg-12">
                ...
                <div class="copyright-area-two">
                    <div class="left">
                        <p>
                            © {{ date('Y') }} <a href="https://bizzone.uz" target="_blank">Bizzone.uz</a>. Все права
                            защищены.
                        </p>
                    </div>
                    <!-- <div class="right">
