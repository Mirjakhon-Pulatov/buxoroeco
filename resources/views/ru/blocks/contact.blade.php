...
@section('seo')
    ...
    <title>Бухарское областное управление по экологии и охране окружающей среды | Контакты</title>
    ...
    <meta property="og:description" content="бухара, экология, областное управление по экологии, buxoroeco.uz/ru, природа, эко контроль, контакты">
    ...
    <meta name="twitter:description" content="бухара, экология, областное управление по экологии, buxoroeco.uz/ru, природа, эко контроль, контакты">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="con-tent-main">
                        <div class="wrapper">
                            <span class="bg-text-stok">Контакты</span>
                            <div class="title skew-up">
                                <a href="{{ url()->current() }}">Контакты</a>
                            </div>
                            <div class="slug skew-up">
                                <a href="{{ url('/ru') }}">Главная /</a>
                                <a class="active" href="{{ url('/ru/contact') }}">Контакты</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="single-contact--info-wrapper">
                        ...
                        <div class="content">
                            ...
                            <a href="https://www.google.com/maps" target="_blank">
                                <h6 class="title">Улица Ширбудин, дом 41 </h6>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7 col-md-12 col-sm-12 col-12">
                    <div class="form--area">
                        <div class="title-area-left">
                            ...
                            <p>
                                <span>При использовании материалов обращайтесь на сайт www.eco.gov.uz.</span>
                            </p>
                        </div>
                        ...
                        <form action="{{ route('murojaat') }}" method="post" class="contact-page-form mt--30">
                            ...
                            <div class="name-email-wraper">
                                <input name="name" type="text" placeholder="Введите ваше Ф.И.О." required>
                                <input name="email" type="email" placeholder="Введите адрес электронной почты"
                                       required>
                            </div>
                            <input type="text" name="subject" placeholder="Введите свой номер телефона">
                            <textarea name="message" placeholder="Введите текст заявки" required></textarea>
                            <button class="rts-btn btn-primary">Отправить</button>
                        </form>
                    </div>
                </div>
